...
class ProxySurface(object):
    ...
    def get_abs_offset(self): return self.rect[:2]
    def get_abs_parent(self): return self.mysubsurface.get_abs_parent()
