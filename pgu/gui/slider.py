...
class _slider(widget.Widget):
    ...
    def __init__(self, value, orient, min, max, size, step=1, **params):
        ...
        super(_slider, self).__init__(**params)
...
class VSlider(_slider):
    ...
    def __init__(self, value, min, max, size, step=1, **params):
        ...
        super(VSlider, self).__init__(value, _SLIDER_VERTICAL, min, max, size, step, **params)
...
class HSlider(_slider):
    ...
    def __init__(self, value, min, max, size, step=1, **params):
        ...
        super(HSlider, self).__init__(value, _SLIDER_HORIZONTAL, min, max, size, step, **params)
...
class HScrollBar(table.Table):
    ...
    def __init__(self, value, min, max, size, step=1, **params):
        ...
        super(HScrollBar, self).__init__(**params)
...
class VScrollBar(table.Table):
    ...
    def __init__(self, value, min, max, size, step=1, **params):
        ...
        super(VScrollBar, self).__init__(**params)
